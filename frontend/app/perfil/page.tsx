    ...
    <div className="bg-black text-white min-h-screen font-sans flex flex-col justify-between">
      ...
      <main className="max-w-md mx-auto w-full px-4 py-6 flex-1 space-y-6">
        <div className="flex flex-col items-center space-y-3">
          <div className="w-24 h-24 bg-zinc-900 border-2 border-blue-500 rounded-full overflow-hidden flex items-center justify-center">
          ...
          <p className="text-[10px] text-gray-500">Matrícula: {usuario.matricula}</p>
        </div>
        ...
        <section className="bg-zinc-950 border border-zinc-800 rounded-xl p-4 space-y-3">
          ...
          <Linha titulo="Status" valor={usuario.status} />
        ...
        <button
          onClick={sair}
          className="w-full text-center bg-zinc-900 border border-zinc-800 hover:border-red-500/30 hover:text-red-400 text-gray-400 text-xs font-bold py-3 rounded-xl transition-all uppercase tracking-wider"
        >
          Sair da Conta
        </button>
      </main>
